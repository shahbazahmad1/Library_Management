...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark"> <a
		class="navbar-brand" href="/LibraryManagement/books/list">Books
		Directory</a>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			<li class="nav-item "><a class="nav-link"
				href="/LibraryManagement/books/showFormForAdd">New Book <span
					class="sr-only">(current)</span></a></li>
					
			<li class="nav-item"><a class="nav-link"
				href="/LibraryManagement/logout"> Logout<span class="sr-only">(current)</span></a></li>
		</ul>
	</div>
	</nav>
	<div class="container">
		...
		<form action="/LibraryManagement/books/search" class="form-inline">
			...
			<a href="/LibraryManagement/books/showFormForAdd"
				class="btn btn-dark btn-sm mb-3"> Add Book </a> 
			...
			<button type="submit" class="btn btn-dark btn-sm mb-3">Search</button>
			<a href="/LibraryManagement/logout"
				class="btn btn-dark btn-sm mb-3 mx-auto" > Logout </a>
